...
; This file contains custom settings for RSS-Bridge. Do not change the default
; file, it will be replaced on the next update of RSS-Bridge! You can specify
; your own configuration in 'config.ini.php' (this file).
...
password = "6tC459F&#V7J419fs#P1LFlG"
